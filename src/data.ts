...
export const LEADERSHIP = {
  ...
  institutionalExpert: {
    ...
    designation: "Professor — Urban Planning, SVNIT Surat",
    bio: "Dr. Chetan R. Patel is an Institutional Expert associated with STC Consultants & Service Provider. He is a Professor in Urban Planning at Sardar Vallabhbhai National Institute of Technology (SVNIT), Surat, bringing academic expertise and institutional perspective to urban planning, research, and professional planning assignments. His association strengthens the firm's academic and institutional planning capabilities."
  },
  coreTeam: [
    {
